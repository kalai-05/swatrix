...
export default function Contact() {
  return (
    <section id="contact" className="py-20 bg-gradient-to-br from-[#0f172a] to-[#1e293b] relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          <motion.h2 
            className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-[#8b5cf6] to-[#06b6d4] bg-clip-text text-transparent"
            initial={{ opacity: 0 }}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <form className="space-y-6">
              ...
              >
                ...
                <input 
                  type="text" 
                  id="name" 
                  className="w-full px-4 py-3 rounded-lg bg-white/5 border border-white/10 focus:outline-none focus:ring-2 focus:ring-[#8b5cf6] text-white placeholder-gray-400 transition-all"
              ...
              <motion.button 
                type="submit" 
                className="w-full px-6 py-3 rounded-lg bg-gradient-to-r from-[#8b5cf6] to-[#06b6d4] text-white font-medium flex items-center justify-center gap-2 hover:shadow-lg hover:shadow-[#8b5cf6]/30 transition-all"
          ...
          >
            {[
              ...
              <motion.div 
                key={index}
                className="flex items-start gap-6 bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:border-[#8b5cf6]/50 transition-all"
                whileHover={{ y: -5 }}
              ...
              >
                <motion.div 
                  className="bg-gradient-to-r from-[#8b5cf6] to-[#06b6d4] p-4 rounded-xl flex-shrink-0"
              ...
              <div className="flex gap-4">
                {[
                  ...
                  <motion.a
                    key={i}
                    href="#"
                    className="bg-white/10 hover:bg-gradient-to-r hover:from-[#8b5cf6] hover:to-[#06b6d4] p-3 rounded-full transition-all flex items-center justify-center"
